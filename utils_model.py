...
def class_names(train_datagen, base_path):
    """
...
def train_val_sets(train_datagen, base_path):
    """
...
train_datagen = image_generator(test_path)
classes = class_names(train_datagen, base_path)
train_generator, validation_generator = train_val_sets(train_datagen, base_path)
